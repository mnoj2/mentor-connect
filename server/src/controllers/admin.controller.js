...
module.exports = {
    ...
    adminLoginHandler: async (req, res) => {
        try {
            ...
            const admin = await Admin.findByCredentials(email, password);  // could throw
            const token = await admin.generateAuthToken();                 // could throw
            ...
            console.error("Login Error Stack:", err.stack);     // Log full error
            console.error("Login Error Message:", err.message); // Helpful for quick issues
